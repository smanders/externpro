...
set(PRO_LIBGEOTIFF
  ...
  GIT_TAG xp${GTIFVER} # what to 'git checkout'
  GIT_REF v${GTIFVER} # create patch from this tag to 'git checkout'
  #DLURL http://libgeotiff-dfsg.sourcearchive.com/downloads/${GTIFVER}/libgeotiff-dfsg_${GTIFVER}.orig.tar.gz
  ...
  DLURL ${REPO}/archive/v${GTIFVER}.tar.gz
  DLMD5 4bef0cc5f066a5f3c0b2352f39bbf140
  DLNAME libgeotiff-v${GTIFVER}.tar.gz
...
function(build_libgeotiff)
  ...
  set(XP_CONFIGURE -DWX_INCLUDE:PATH=${wxInc} -DGEOTIFF_VER=${GTIFVER})
