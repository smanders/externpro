...
if(UNIX)
  ...
  if(DEFINED zlibBinary)
    add_definitions(-DBOOST_ZLIB_BINARY=$<TARGET_FILE:${zlibBinary}>)
  endif()
  if(DEFINED bzip2Binary)
    add_definitions(-DBOOST_BZIP2_BINARY=$<TARGET_FILE:${bzip2Binary}>)
  endif()
endif()
