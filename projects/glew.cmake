...
function(patch_glew)
  ...
  if(XP_DEFAULT OR (XP_PRO_GLEW AND NOT (XP_PRO_GLEW_${mswVer} OR XP_PRO_GLEW_${bldVer})))
    if(WIN32)
      set(XP_PRO_GLEW_${mswVer} ON CACHE BOOL "include glew_${mswVer}" FORCE)
      set(XP_PRO_GLEW_${bldVer} OFF CACHE BOOL "include glew_${bldVer}" FORCE)
    else()
      set(XP_PRO_GLEW_${mswVer} OFF CACHE BOOL "include glew_${mswVer}" FORCE)
      set(XP_PRO_GLEW_${bldVer} ON CACHE BOOL "include glew_${bldVer}" FORCE)
    endif()
  endif()
endfunction()
########################################
