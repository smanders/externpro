...
|[LLVM](http://llvm.org/ 'LLVM website')|[open](https://releases.llvm.org/3.9.0/LICENSE.TXT 'LLVM Release License')|The LLVM Compiler Infrastructure|3.9.0|[repo](https://github.com/llvm/llvm-project 'llvm repo on github')|none|
...
|llvm|[clang](http://clang.llvm.org/ 'clang website')|clang: a C language family frontend for LLVM|3.9.0|none|none|
