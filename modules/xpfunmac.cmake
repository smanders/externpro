...
function(xpBuildDeps depTargets)
  ...
  foreach(dep ${P_BUILD_DEPS})
    ...
    xpGetArgValue(${PRO_${DEP}} ARG BUILD_FUNC VALUE BUILD_FUNC)
    file(WRITE ${buildDep} "${BUILD_FUNC}(${dep}Tgts)\n")
    include(${buildDep})
    list(APPEND targets ${${dep}Tgts})
    # some projects have variables that need to be passed up
    xpGetArgValue(${PRO_${DEP}} ARG BUILD_VARS VALUES BUILD_VARS)
    if(NOT BUILD_VARS STREQUAL "unknown")
      foreach(var ${BUILD_VARS})
