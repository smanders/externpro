...
function(xpRepo)
  ...
  if(NOT TARGET ${prj}_repo AND (XP_DEFAULT OR XP_PRO_${PRJ} OR XP_PRO_${SUPERPRJ}))
...
function(xpCloneProject)
  set(oneValueArgs GIT_ORIGIN)
  cmake_parse_arguments(R "" "${oneValueArgs}" "" ${ARGN})
  if(DEFINED R_GIT_ORIGIN)
    xpRepo(${ARGN})
  endif()
endfunction()
