...
if(NOT DEFINED xpSourceDir)
  message(FATAL_ERROR "xpSourceDir must be set before including cmsrevision.cmake")
endif()
if(NOT DEFINED xpRelBranch)
  message(FATAL_ERROR "xpRelBranch must be set before including cmsrevision.cmake")
endif()
include(FindGit)
...
if(GIT_FOUND AND EXISTS "${xpSourceDir}/.git")
  # xpRelBranch (release branch): year.week-date-gitdescribe (12.20-20120518-gitdescribe)
  # other branches: user-branch-date-gitdescribe (smanders-padawan-20120518-gitdescribe)
  ...
  if(${branchName} STREQUAL ${xpRelBranch})
    string(TIMESTAMP yw %y.%U)
    set(revisionPrefix "${yw}")
  elseif(UNIX)
  ...
  set(xpRevision "${revisionPrefix}-${ymd}-${gitDescribe}")
else()
